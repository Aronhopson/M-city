...
import TheMaches from './components/theMatches'
import NotFound from './components/UI/Eror';
    ...
    <div>
      <Layout>
        <Switch>
           ...
           <PublicRoutes {...props} restricted={false}  path="/the_matches" component={TheMaches} />
